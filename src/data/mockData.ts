...
export const mockProducts: Product[] = [
  {
    ...
    seller_id: 's1', category: 'Mobile', stock: 50, approved: true, created_at: '2026-01-15', brand: 'Samsung', rating: 4.8, discount: 10, isNew: true, is_featured: true,
  },
  {
    ...
    seller_id: 's2', category: 'Laptops', stock: 25, approved: true, created_at: '2026-01-10', brand: 'Apple', rating: 4.9, discount: 5, isNew: true, is_featured: true,
  },
  {
    ...
    seller_id: 's3', category: 'Audio', stock: 80, approved: true, created_at: '2026-01-12', brand: 'Sony', rating: 4.7, discount: 15, is_featured: true,
  },
  {
    ...
    seller_id: 's2', category: 'Tablets', stock: 30, approved: true, created_at: '2026-01-08', brand: 'Apple', rating: 4.8, discount: 8, is_featured: true,
  },
  {
    ...
    seller_id: 's4', category: 'Cameras', stock: 15, approved: true, created_at: '2026-01-05', brand: 'Canon', rating: 4.9, discount: 0, isNew: true, is_featured: true,
  },
  {
    ...
    seller_id: 's5', category: 'Gaming', stock: 40, approved: true, created_at: '2026-01-18', brand: 'Sony', rating: 4.6, discount: 0, is_featured: true,
  },
  {
    ...
    seller_id: 's2', category: 'Watches', stock: 20, approved: true, created_at: '2026-01-20', brand: 'Apple', rating: 4.7, discount: 5, isNew: true, is_featured: true,
  },
  {
    ...
    seller_id: 's6', category: 'Smart Home', stock: 60, approved: true, created_at: '2026-01-14', brand: 'Google', rating: 4.4, discount: 12, is_featured: true,
  },
  {
    ...
    seller_id: 's3', category: 'Audio', stock: 100, approved: true, created_at: '2026-01-22', brand: 'Bose', rating: 4.5, discount: 10, is_featured: true,
  },
  {
    ...
    seller_id: 's1', category: 'Tablets', stock: 35, approved: true, created_at: '2026-01-25', brand: 'Samsung', rating: 4.3, discount: 15, is_featured: true,
  },
];
...
export const hotDeals: Product[] = [
  {
    ...
    seller_id: 's7', category: 'Mobile', stock: 45, approved: true, created_at: '2026-01-10', brand: 'OnePlus', rating: 4.6, discount: 25,
  },
  {
    ...
    seller_id: 's8', category: 'Laptops', stock: 20, approved: true, created_at: '2026-01-08', brand: 'Lenovo', rating: 4.3, discount: 30,
  },
  {
    ...
    seller_id: 's3', category: 'Audio', stock: 70, approved: true, created_at: '2026-01-12', brand: 'JBL', rating: 4.5, discount: 35,
  },
  {
    ...
    seller_id: 's9', category: 'Watches', stock: 55, approved: true, created_at: '2026-01-15', brand: 'Amazfit', rating: 4.2, discount: 40,
  },
  {
    ...
    seller_id: 's4', category: 'Cameras', stock: 18, approved: true, created_at: '2026-01-20', brand: 'GoPro', rating: 4.6, discount: 20,
  },
  {
    ...
    seller_id: 's5', category: 'Gaming', stock: 30, approved: true, created_at: '2026-01-18', brand: 'Nintendo', rating: 4.7, discount: 22,
  },
  {
    ...
    seller_id: 's7', category: 'Fitness', stock: 200, approved: true, created_at: '2026-01-22', brand: 'Xiaomi', rating: 4.1, discount: 45,
  },
  {
    ...
    seller_id: 's1', category: 'Storage', stock: 90, approved: true, created_at: '2026-01-25', brand: 'Samsung', rating: 4.5, discount: 28,
  },
  {
    ...
    seller_id: 's10', category: 'Accessories', stock: 150, approved: true, created_at: '2026-01-28', brand: 'Anker', rating: 4.4, discount: 30,
  },
  {
    ...
    seller_id: 's7', category: 'Tablets', stock: 40, approved: true, created_at: '2026-02-01', brand: 'Realme', rating: 4.0, discount: 32,
  },
];
...
export const trendingDeals: Product[] = [
  {
    ...
    seller_id: 's2', category: 'Mobile', stock: 35, approved: true, created_at: '2026-01-28', brand: 'Apple', rating: 4.9, discount: 5, isNew: true,
  },
  {
    ...
    seller_id: 's8', category: 'Laptops', stock: 12, approved: true, created_at: '2026-01-22', brand: 'ASUS', rating: 4.7, discount: 10,
  },
  {
    ...
    seller_id: 's2', category: 'Audio', stock: 65, approved: true, created_at: '2026-01-30', brand: 'Apple', rating: 4.8, discount: 8, isNew: true,
  },
  {
    ...
    seller_id: 's9', category: 'Watches', stock: 22, approved: true, created_at: '2026-01-26', brand: 'Garmin', rating: 4.6, discount: 12,
  },
  {
    ...
    seller_id: 's4', category: 'Cameras', stock: 10, approved: true, created_at: '2026-02-01', brand: 'DJI', rating: 4.8, discount: 0, isNew: true,
  },
  {
    ...
    seller_id: 's5', category: 'Gaming', stock: 25, approved: true, created_at: '2026-01-20', brand: 'Microsoft', rating: 4.5, discount: 10,
  },
  {
    ...
    seller_id: 's6', category: 'Smart Home', stock: 38, approved: true, created_at: '2026-01-24', brand: 'Amazon', rating: 4.3, discount: 18,
  },
  {
    ...
    seller_id: 's9', category: 'Fitness', stock: 75, approved: true, created_at: '2026-02-02', brand: 'Fitbit', rating: 4.4, discount: 15, isNew: true,
  },
  {
    ...
    seller_id: 's6', category: 'Mobile', stock: 28, approved: true, created_at: '2026-02-03', brand: 'Google', rating: 4.7, discount: 7, isNew: true,
  },
  {
    ...
    seller_id: 's10', category: 'Accessories', stock: 120, approved: true, created_at: '2026-02-05', brand: 'Logitech', rating: 4.6, discount: 10,
  },
];
